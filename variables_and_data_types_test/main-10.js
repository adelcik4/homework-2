...
console.log(
  `Меня зовут ${firstName} ${lastName}, мне ${age}. Я учченик курса: ${isStudent}`,
);
...
// наверное будет 123456790
// ладно я посмотрел там 123456789falsetrue, я думал тру принимает значение 1 а фолс 0
